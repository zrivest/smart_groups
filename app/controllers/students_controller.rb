class StudentsController < ApplicationController
  ...
  def create
    ...
    a = Assignment.create(assignment_name: params[:users][:students][:assignment_name], start_date: params[:users][:students][:start_date], due_date: params[:users][:students][:due_date], course_id: course.course_id)
